...
class FeedController(
    ...
    fun deleteProcessingFeed(
        ...
        feedService.deleteProcessingFeed(userAccount.userId, feedId)
    ...
    @Operation(summary = "중요/미분류/전체 피드 리스트 조회 api", description = "type은 BOOKMARKED / UNCLASSIFIED / ALL (String)으로 구분됩니다.")
    @PostMapping("/by-type")
    fun getFeedsByType(
